 ...
 */
class AssessRatedQueryController extends AbstractController
{
    /**
     * @var string
     */
    protected const URL_QUERY_LIST = '/search-ranking-optimizer/assess-rated-query';
    ...
    public function editAction(Request $request)
    {
        $idSearchRankingQuery = $this->castId(
            $request->query->get(AssessRatedQueryTable::URL_PARAM_ID_SEARCH_RANKING_QUERY),
        );
