...
class OptimizationController extends AbstractController
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if ($optimizeRunForm->isSubmitted() && $optimizeRunForm->isValid()) {
            ...
            $storeName = (string)$formData[OptimizeRunForm::FIELD_STORE_NAME];
            $localeName = (string)$formData[OptimizeRunForm::FIELD_LOCALE_NAME];
            $algorithm = (string)$formData[OptimizeRunForm::FIELD_ALGORITHM];
            ...
            return $this->redirectResponse(sprintf(
                ...
                OptimizeRunForm::FIELD_STORE_NAME,
                $storeName,
                OptimizeRunForm::FIELD_LOCALE_NAME,
                $localeName,
            ));
        }

        $storeName = (string)$request->query->get(OptimizeRunForm::FIELD_STORE_NAME, '');
        $localeName = (string)$request->query->get(OptimizeRunForm::FIELD_LOCALE_NAME, '');
