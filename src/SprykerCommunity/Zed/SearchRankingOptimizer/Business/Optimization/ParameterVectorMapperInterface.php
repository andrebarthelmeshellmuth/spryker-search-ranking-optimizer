 ...
 * search — see the constructor). One mapper instance is scoped to a single optimization run's fixed set of
 * active metrics — build a fresh one per run, never share one across runs with a different metric set.
 */
